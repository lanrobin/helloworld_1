...
public interface IOperation {
	 ...
	 * @param l
	 */
	void create(ICloudObject parent, String name, String description, int type, IOperationListener l);
	 ...
	 * @param l
	 */
	void upload(ICloudObject parent, String name, InputStream is, IOperationListener l);
	
	void upload(ICloudObject parent, String name, File file, IOperationListener l);
	...
	public interface IOperationListener {
		...
		int ERROR_CODE_INVALID_PARAM = 4;
		int ERROR_CODE_UNKNOWN = -1;
		
		void onListFinished(Iterable<? extends ICloudObject> list, int errcode, String msg);
		void onCreatedFinished(ICloudObject file, int errcode, String msg);
		void onDeleteFinished(int errcode, String msg);
		void onUploading(ICloudObject file, long total, long cur, int errcode, String msg);
