...
import com.irefire.cloud.audiorecorder.audio.AudioRecordThread;
import com.irefire.cloud.audiorecorder.main.MainApp;
import com.irefire.cloud.auth.skydrive.SkyDriveOperation;
import com.irefire.cloud.auth.skydrive.SkydriveJsonKey;
import com.irefire.cloud.auth.ui.SkyDriveSignInActivity;
	...
	public void onClick(View v) {
		...
		case R.id.main_button_test:
			...
			*/
			...
			Intent intent1 = new Intent(this, AudioRecordActivity.class);
